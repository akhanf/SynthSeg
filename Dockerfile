...
RUN wget https://www.dropbox.com/s/i62tzl821mqi3vd/synths_models_freesurfer_7.3.2.zip && \
    unzip -d /SynthSeg/models synths_models_freesurfer_7.3.2.zip && rm -f synths_models_freesurfer_7.3.2.zip
